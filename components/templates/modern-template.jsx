    ...
    <div className="p-8 font-sans text-gray-800">
      ...
      {personal.summary && (
        <section className="mb-6">
          <h2 className="text-xl font-semibold border-b-2 border-gray-300 pb-1 mb-3">Professional Summary</h2>
      ...
      {certifications.length > 0 && certifications[0].name && (
        <section className="mb-6">
          <h2 className="text-xl font-semibold border-b-2 border-gray-300 pb-1 mb-3">Certifications</h2>
      ...
      {projects.length > 0 && projects[0].name && (
        <section className="mb-6">
          <h2 className="text-xl font-semibold border-b-2 border-gray-300 pb-1 mb-3">Projects</h2>
