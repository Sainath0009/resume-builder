      ...
      <div className="p-8">
        ...
        {personal.summary && (
          <section className="mb-6">
            <h2 className="text-xl font-bold text-gray-800 mb-3 pb-1 border-b-2 border-gray-800">
        ...
        {education.length > 0 && education[0].institution && (
          <section className="mb-6">
            <h2 className="text-xl font-bold text-gray-800 mb-3 pb-1 border-b-2 border-gray-800">Education</h2>
        ...
        {certifications.length > 0 && certifications[0].name && (
          <section className="mb-6">
            <h2 className="text-xl font-bold text-gray-800 mb-3 pb-1 border-b-2 border-gray-800">Certifications</h2>
        ...
        {/* Skills */}
        <section className="mb-6">
          <h2 className="text-xl font-bold text-gray-800 mb-3 pb-1 border-b-2 border-gray-800">Skills</h2>
        ...
        {projects.length > 0 && projects[0].name && (
          <section>
            <h2 className="text-xl font-bold text-gray-800 mb-3 pb-1 border-b-2 border-gray-800">Projects</h2>
            {projects.map((project, index) => (
              <div key={index} className="mb-4">
                ...
                {project.technologies && <p className="text-base font-medium">Technologies: {project.technologies}</p>}
